...
namespace BookingApp.Controllers
{
  ...
  {
    private BAContext context = new BAContext();
    ...
    public async Task<IHttpActionResult> Register(RegisterBindingModel model)
    {
      ...
      if (!context.Users.Any(u => u.UserName == model.Username))
      {
        ...
        var user = new BAIdentityUser() { Id = model.Username, UserName = model.Username, Email = model.Email, AppUserId = userr.Id, AppUser = appUser, PasswordHash = BAIdentityUser.HashPassword(model.Password) };
